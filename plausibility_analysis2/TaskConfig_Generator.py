...
# trial parameters
params['nTrials'] = 1050 #number of trials in each block

# State Parameters
params['Mu'] = 1 #mean for normal distribution
params['HazRes']=0.05
params['Hazards'] =np.arange(0.05, 1, params['HazRes']) 
params['nEvidence']=20
params['xLim']=5
params['testSigmas']=[0.1] #variance for the normal distribution
